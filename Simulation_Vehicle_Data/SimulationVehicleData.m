    ...
    methods (Static)
        ...
        function dataRow = formatActorToRowData(actor, pastTable, timestamp, timeStep, egoPos, egoXUnitVector, egoYUnitVector, egoVel, egoYaw)
            ...
            dataRow = [ timestamp, ...
                ...
                vel(1), ...
                vel(2),...
                (vel(1) - pastTable(actor.ActorID, SimulationVehicleData.TABLE_INDEX_V_X)) / timeStep, ...
                (vel(2) - pastTable(actor.ActorID, SimulationVehicleData.TABLE_INDEX_V_Y)) / timeStep,...
                heading, ...
                (deg2rad(heading - pastTable(actor.ActorID, SimulationVehicleData.TABLE_INDEX_H))) / timeStep, norm(egoPos - pos(1:2))]';
